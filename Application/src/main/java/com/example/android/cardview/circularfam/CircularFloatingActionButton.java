 ...
 */
public class CircularFloatingActionButton extends FrameLayout {
    ...
    /**
     * Constructor that takes parameters collected using {@link CircularFloatingActionMenu.Builder}
     ...
     * @param contentParams
     */
    public CircularFloatingActionButton(Context context, ViewGroup.LayoutParams layoutParams, int theme,
    ...
    /**
     * A builder for {@link CircularFloatingActionButton} in conventional Java Builder format
     */
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            setTheme(CircularFloatingActionButton.THEME_LIGHT);
        ...
        public CircularFloatingActionButton build() {
            return new CircularFloatingActionButton(context,
                                           layoutParams,
                                           theme,
                                           backgroundDrawable,
                                           position,
