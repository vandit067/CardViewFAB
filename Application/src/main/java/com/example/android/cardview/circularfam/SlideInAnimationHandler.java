...
//            PropertyValuesHolder pvhsY = PropertyValuesHolder.ofFloat(View.SCALE_Y, 0);
    ...
    protected class SubActionItemAnimationListener implements Animator.AnimatorListener {
        ...
        private CircularFloatingActionMenu.Item subActionItem;
        private ActionType actionType;

        public SubActionItemAnimationListener(CircularFloatingActionMenu.Item subActionItem, ActionType actionType) {
