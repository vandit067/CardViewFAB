...
public abstract class MenuAnimationHandler {
    ...
    protected CircularFloatingActionMenu menu;

    public MenuAnimationHandler() {
    }

    public void setMenu(CircularFloatingActionMenu menu) {
        this.menu = menu;
    }
     ...
     * @param actionType
     */
    protected void restoreSubActionViewAfterAnimation(CircularFloatingActionMenu.Item subActionItem, ActionType actionType) {
