...
public class CircularFloatingActionMenu {
    ...
    /**
     * Constructor that takes the parameters collected using {@link CircularFloatingActionMenu.Builder}
     ...
     * @param animated
     */
    public CircularFloatingActionMenu(final View mainActionView,
                                      int startAngle,
                                      int endAngle,
                                      int radius,
    ...
    /**
     * A builder for {@link CircularFloatingActionMenu} in conventional Java Builder format
     */
    public static class Builder {
        ...
        public CircularFloatingActionMenu build() {
            return new CircularFloatingActionMenu(actionView,
                                          startAngle,
                                          endAngle,
                                          radius,
                                          subActionItems,
