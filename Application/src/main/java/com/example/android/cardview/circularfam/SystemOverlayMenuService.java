...
public class SystemOverlayMenuService extends Service {
    ...
    private CircularFloatingActionButton rightLowerButton;
    private CircularFloatingActionButton topCenterButton;

    private CircularFloatingActionMenu rightLowerMenu;
    private CircularFloatingActionMenu topCenterMenu;
    ...
    public void onCreate() {
        ...
        WindowManager.LayoutParams params = CircularFloatingActionButton.Builder.getDefaultSystemWindowParams(this);

        rightLowerButton = new CircularFloatingActionButton.Builder(this)
        ...
        rightLowerMenu = new CircularFloatingActionMenu.Builder(this, true)
        ...
        WindowManager.LayoutParams params2 = CircularFloatingActionButton.Builder.getDefaultSystemWindowParams(this);
        params2.width = redActionButtonSize;
        params2.height = redActionButtonSize;

        topCenterButton = new CircularFloatingActionButton.Builder(this)
                .setSystemOverlay(true)
                .setContentView(fabIconStar, fabIconStarParams)
                .setBackgroundDrawable(R.drawable.button_action_red_selector)
                .setPosition(CircularFloatingActionButton.POSITION_TOP_CENTER)
        ...
        topCenterMenu = new CircularFloatingActionMenu.Builder(this, true)
        ...
        topCenterMenu.setStateChangeListener(new CircularFloatingActionMenu.MenuStateChangeListener() {
            @Override
